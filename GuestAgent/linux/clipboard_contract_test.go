...
func TestClipboardRequestAcceptsBoundedIntegrationPaths(t *testing.T) {
	...
	expected := "/mnt/ezvm-shared/.ezvm-integration/clipboard/01234567-89ab-cdef-0123-456789abcdef.txt"
	if path != expected {
...
func TestClipboardRequestRejectsTraversalMIMEAndOversize(t *testing.T) {
	valid := clipboardRequest{
		RelativePath: ".ezvm-integration/clipboard/01234567-89ab-cdef-0123-456789abcdef.png",
		MIMEType:     clipboardImageMIME,
	}
	cases := map[string]clipboardRequest{
		"traversal":      {RelativePath: ".ezvm-integration/clipboard/../secret.png", MIMEType: clipboardImageMIME},
