    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("The signed-release list updates automatically via IPSW.me. Downloads come directly from Apple; EZVM performs the final host compatibility check before installation.")
                    .font(.caption2)
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            if catalog.isRefreshing {
                ...
                Label("Installer list updates without an EZVM release", systemImage: "checkmark.circle.fill")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
