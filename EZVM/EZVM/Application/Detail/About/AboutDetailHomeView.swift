...
struct AppInfo {
    ...
    static var diagnosticText: String {
        "EZVM \(version) (\(build)) on macOS \(ProcessInfo.processInfo.operatingSystemVersionString)"
    }
}
    ...
    var body: some View {
        VStack(spacing: 12) {
            ...
            DetailLinkCardView(
                image: "globe",
                title: "Website",
                subtitle: "xnu.app/ezvm",
                urlString: "https://xnu.app/ezvm"
            )
            DetailLinkCardView(
            ...
            DetailLinkCardView(
                ...
                urlString: "https://github.com/everettjf/ezvm/releases"
            )
